...
echo Copy output
cp -v $HOME/LIVE_BOOT/debian-custom.iso /output/debian10-minimal-x86_64.iso
chmod -v 666 $HOME/LIVE_BOOT/debian-custom.iso /output/debian10-minimal-x86_64.iso
ls -lah /output
